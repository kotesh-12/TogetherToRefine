export const GURUKUL_HEROES = {
    ...
    abhimanyu: { id: 'abhimanyu', name: 'Abhimanyu (Siddh)', emoji: '🛡️', title: 'Siddh Autonomous Agent', trait: 'Autonomous Audits & Action' },
...
export const SECURE_HEROES = {
    ...
    abhimanyu: { id: 'abhimanyu', name: 'Spider-Man (Siddh)', emoji: '🕸️', title: 'Siddh Tactical Agent', trait: 'Autonomous Audits & Action' },
